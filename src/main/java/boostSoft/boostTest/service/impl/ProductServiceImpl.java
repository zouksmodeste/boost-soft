...
public class ProductServiceImpl implements ProductServiceApi {
	...
	public HttpEntity<? extends Object> createProduct(Product product, Principal principal) {
		try {
			...
			return new ResponseEntity<Product>(currentProduct, HttpStatus.CREATED); // renvoie du produit avec une reponse http
		} catch (Exception e) {
	...
	public HttpEntity<? extends Object> updateProduct(Product product) {
		try {
			...
			if (product.getTitle()!= null || product.getDateCreation()!= null || product.getPrice()!= 0 || product.getQuantity()!= 0 || product.getStatus()!= null) { // verification des attributs en bases de donnees et ceux fournis par l'utilisateur dans le formulaire
				...
				return new ResponseEntity<Product>(currentProduct, HttpStatus.OK);  // renvoie du produit avec une reponse http
			}else {
				return new ResponseEntity<Product>(currentProduct, HttpStatus.OK);  // renvoie du produit avec une reponse http
			}
		} catch (Exception e) {
	...
	public HttpEntity<? extends Object> findAll() {
		try {
			return new ResponseEntity<List<Product>>(productRepository.findAll(), HttpStatus.FOUND);  // renvoie la liste de tous les produits et une reponse http
		} catch (Exception e) {
			return new ResponseEntity<String>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR); // renvoie d'un message d'erreur avec un code http
		}
	}
	...
	public HttpEntity<? extends Object> findByOrderByDateCreationDesc() {
		try {
			return new ResponseEntity<List<Product>>(productRepository.findByOrderByDateCreationDesc(), HttpStatus.FOUND); // renvoie la liste de tous les produits par ordre decroissant de creation et une reponse http
		} catch (Exception e) {
			return new ResponseEntity<String>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR); // renvoie d'un message d'erreur avec un code http
		}
	}
	...
	public HttpEntity<? extends Object> findByOrderByDateCreationAsc() {
		try {
			return new ResponseEntity<List<Product>>(productRepository.findByOrderByDateCreationAsc(), HttpStatus.FOUND); // renvoie la liste de tous les produits par ordre croissant de creation et une reponse http
		} catch (Exception e) {
			return new ResponseEntity<String>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR); // renvoie d'un message d'erreur avec un code http
		}
	}
	...
	public HttpEntity<? extends Object> findByPrice(float price) {
		try {
			return new ResponseEntity<List<Product>>(productRepository.findByPrice(price), HttpStatus.FOUND); // renvoie une liste de produits ayant le meme prix avec une reponse hhtp
		} catch (Exception e) {
			return new ResponseEntity<String>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR); // renvoie d'un message d'erreur avec un code http
		}
	}
